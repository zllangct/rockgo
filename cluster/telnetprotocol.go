...
func (this *TelnetProtocol) GetMsgHandle() RockInterface.Imsghandle {
	return nil
}
func (this *TelnetProtocol) GetDataPack() RockInterface.Idatapack {
	return nil
}
...
func (this *TelnetProtocol)getConnectionAddr(fconn RockInterface.ISession)[]string{
	return strings.Split(fconn.RemoteAddr().String(), ":")
}

func (this *TelnetProtocol) OnConnectionMade(fconn RockInterface.ISession) {
...
func (this *TelnetProtocol) OnConnectionLost(fconn RockInterface.ISession) {
	logger.Info(fmt.Sprintf("client ID: %d disconnected. IP Address: %s", fconn.GetSessionId(), fconn.RemoteAddr()))
}

func (this *TelnetProtocol) StartReadThread(fconn RockInterface.ISession) {
